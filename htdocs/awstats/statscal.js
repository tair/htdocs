...
var gEnd=[2020,12,12];	// calendar date range end at [Year,Month,Date]
...
var gsCalTitle="'<div style=\"width:100%\" title=\"'+gMonths[gCurMonth[1]-1]+'\"><a class=MonthNav href=\"javascript:void(0)\"  onclick=\"fHeaderClick('+gCurMonth[0]+','+gCurMonth[1]+');return false\">'+gMonths[gCurMonth[1]-1]+'</a></div>'";	// dynamic statement to be eval-ed as the title when giDCStyle>0.
//var gsCalTitle="'<div style=\"width:100%\" title=\"'+gMonths[gCurMonth[1]-1]+'\"><a class=MonthNav href=\"javascript:void(0)\"  onclick=\"fHeaderClick('+gCurMonth[0]+','+gCurMonth[1]+');return false\">'+gMonths[((gCurMonth[1]-giFirstMonth+12)%12)]+'</a></div>'";	// dynamic statement to be eval-ed as the title when giDCStyle>0.
